<?php /* Smarty version Smarty-3.1.13, created on 2014-12-26 01:49:11
         compiled from "/home/han4a2d1/public_html/modules/csquickview/views/templates/front/csproduct.tpl" */ ?>
<?php /*%%SmartyHeaderCode:998076123549d04e71bc655-82320361%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0371277dede3b246c59effdaaa96bf726a99e1ce' => 
    array (
      0 => '/home/han4a2d1/public_html/modules/csquickview/views/templates/front/csproduct.tpl',
      1 => 1419505432,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '998076123549d04e71bc655-82320361',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_549d04e79a2c24_30722129',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_549d04e79a2c24_30722129')) {function content_549d04e79a2c24_30722129($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/home/han4a2d1/public_html/tools/smarty/plugins/modifier.escape.php';
...
';
var doesntExistNoMoreBut = '<?php echo smartyTranslate(array('s'=>'with those attributes but is available with others','js'=>1,'mod'=>'csquickview'),$_smarty_tpl);?>
';
var uploading_in_progress = '<?php echo smartyTranslate(array('s'=>'Uploading in progress, please wait...','js'=>1),$_smarty_tpl);?>
';
var fieldRequired = '<?php echo smartyTranslate(array('s'=>'Please fill in all required fields, then save the customization.','js'=>1,'mod'=>'csquickview'),$_smarty_tpl);?>
';
...
<div id="primary_block" class="clearfix">
	...
	<div id="admin-action">
		<p><?php echo smartyTranslate(array('s'=>'This product is not visible to your customers.','mod'=>'csquickview'),$_smarty_tpl);?>

		<input type="hidden" id="admin-action-product-id" value="<?php echo $_smarty_tpl->tpl_vars['product']->value->id;?>
" />
		<input type="submit" value="<?php echo smartyTranslate(array('s'=>'Publish','mod'=>'csquickview'),$_smarty_tpl);?>
...
')"/>
		<input type="submit" value="<?php echo smartyTranslate(array('s'=>'Back','mod'=>'csquickview'),$_smarty_tpl);?>
" class="exclusive" onclick="submitPublishProduct('<?php echo $_smarty_tpl->tpl_vars['base_dir']->value;?>
<?php echo smarty_modifier_escape($_GET['ad'], 'htmlall', 'UTF-8');?>
...
" onclick="$('span#wrapResetImages').hide('slow');return (false);"><?php echo smartyTranslate(array('s'=>'Display all pictures','mod'=>'csquickview'),$_smarty_tpl);?>
</a></span></p><?php }?>
		<!-- usefull links-->
	</div>
	...
	<div id="pb-left-column">
		...
		<div id="short_description_block">
			...
			<p class="buttons_bottom_block"><a href="javascript:{}" class="button"><?php echo smartyTranslate(array('s'=>'More details','mod'=>'csquickview'),$_smarty_tpl);?>
</a></p>
			<?php }?>
			<?php if (count($_smarty_tpl->tpl_vars['packItems']->value)>0){?>
			<div class="short_description_pack">
				<h3><?php echo smartyTranslate(array('s'=>'Pack content','mod'=>'csquickview'),$_smarty_tpl);?>
</h3>
...
<br/>
			...
			<p id="product_reference" <?php if (isset($_smarty_tpl->tpl_vars['groups']->value)||!$_smarty_tpl->tpl_vars['product']->value->reference){?>style="display: none;"<?php }?>>
				<label for="product_reference"><?php echo smartyTranslate(array('s'=>'Reference:','mod'=>'csquickview'),$_smarty_tpl);?>
 </label>
			...
			<p id="quantity_wanted_p"<?php if ((!$_smarty_tpl->tpl_vars['allow_oosp']->value&&$_smarty_tpl->tpl_vars['product']->value->quantity<=0)||$_smarty_tpl->tpl_vars['virtual']->value||!$_smarty_tpl->tpl_vars['product']->value->available_for_order||$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value){?> style="display: none;"<?php }?>>
				<label><?php echo smartyTranslate(array('s'=>'Quantity:','mod'=>'csquickview'),$_smarty_tpl);?>
</label>
...
<?php }else{ ?>1<?php }?><?php }?>" size="2" maxlength="3" <?php if ($_smarty_tpl->tpl_vars['product']->value->minimal_quantity>1){?>onkeyup="checkMinimalQuantity(<?php echo $_smarty_tpl->tpl_vars['product']->value->minimal_quantity;?>
			...
			<p id="minimal_quantity_wanted_p"<?php if ($_smarty_tpl->tpl_vars['product']->value->minimal_quantity<=1||!$_smarty_tpl->tpl_vars['product']->value->available_for_order||$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value){?> style="display: none;"<?php }?>>
				<?php echo smartyTranslate(array('s'=>'This product is not sold individually. You must select at least','mod'=>'csquickview'),$_smarty_tpl);?>
 <b id="minimal_quantity_label"><?php echo $_smarty_tpl->tpl_vars['product']->value->minimal_quantity;?>
</b> <?php echo smartyTranslate(array('s'=>'quantity for this product.','mod'=>'csquickview'),$_smarty_tpl);?>
			...
			<p id="availability_statut"<?php if (($_smarty_tpl->tpl_vars['product']->value->quantity<=0&&!$_smarty_tpl->tpl_vars['product']->value->available_later&&$_smarty_tpl->tpl_vars['allow_oosp']->value)||($_smarty_tpl->tpl_vars['product']->value->quantity>0&&!$_smarty_tpl->tpl_vars['product']->value->available_now)||!$_smarty_tpl->tpl_vars['product']->value->available_for_order||$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value){?> style="display: none;"<?php }?>>
				<span id="availability_label"><?php echo smartyTranslate(array('s'=>'Availability:','mod'=>'csquickview'),$_smarty_tpl);?>
</span>
...
<?php }else{ ?><?php echo smartyTranslate(array('s'=>'This product is no longer in stock','mod'=>'csquickview'),$_smarty_tpl);?>
...
<?php }?>
			...
			<p id="pQuantityAvailable"<?php if ($_smarty_tpl->tpl_vars['product']->value->quantity<=0){?> style="display: none;"<?php }?>>
				...
				<span <?php if ($_smarty_tpl->tpl_vars['product']->value->quantity>1){?> style="display: none;"<?php }?> id="quantityAvailableTxt"><?php echo smartyTranslate(array('s'=>'item in stock','mod'=>'csquickview'),$_smarty_tpl);?>
</span>
				<span <?php if ($_smarty_tpl->tpl_vars['product']->value->quantity==1){?> style="display: none;"<?php }?> id="quantityAvailableTxtMultiple"><?php echo smartyTranslate(array('s'=>'items in stock','mod'=>'csquickview'),$_smarty_tpl);?>
</span>
			</p>
			<?php }?>

			
			<p class="warning_inline" id="last_quantities"<?php if (($_smarty_tpl->tpl_vars['product']->value->quantity>$_smarty_tpl->tpl_vars['last_qties']->value||$_smarty_tpl->tpl_vars['product']->value->quantity<=0)||$_smarty_tpl->tpl_vars['allow_oosp']->value||!$_smarty_tpl->tpl_vars['product']->value->available_for_order||$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value){?> style="display: none"<?php }?> ><?php echo smartyTranslate(array('s'=>'Warning: Last items in stock!','mod'=>'csquickview'),$_smarty_tpl);?>
</p>
		</div>
		...
		<div class="content_prices clearfix">
			...
			<p class="online_only"><?php echo smartyTranslate(array('s'=>'Online only','mod'=>'csquickview'),$_smarty_tpl);?>
</p>
			<?php }?>
...
" class="on_sale_img"/>
				...
				<?php }elseif($_smarty_tpl->tpl_vars['product']->value->specificPrice&&$_smarty_tpl->tpl_vars['product']->value->specificPrice['reduction']&&$_smarty_tpl->tpl_vars['productPriceWithoutReduction']->value>$_smarty_tpl->tpl_vars['productPrice']->value){?>
					<span class="discount"><?php echo smartyTranslate(array('s'=>'Reduced price!','mod'=>'csquickview'),$_smarty_tpl);?>
</span>
				<?php }?>
...
</span>&nbsp;<?php echo smartyTranslate(array('s'=>'tax excl.','mod'=>'csquickview'),$_smarty_tpl);?>
</span>
				<?php }?>
			</div>
...
<?php }?></span> <?php echo smartyTranslate(array('s'=>'for green tax'),$_smarty_tpl);?>
					...
					<?php if ($_smarty_tpl->tpl_vars['product']->value->specificPrice&&$_smarty_tpl->tpl_vars['product']->value->specificPrice['reduction']){?>
					<br /><?php echo smartyTranslate(array('s'=>'(not impacted by the discount)','mod'=>'csquickview'),$_smarty_tpl);?>
 ...
 <?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['product']->value->unity, 'htmlall', 'UTF-8');?>
			...
			<?php if ((!$_smarty_tpl->tpl_vars['allow_oosp']->value&&$_smarty_tpl->tpl_vars['product']->value->quantity<=0)||!$_smarty_tpl->tpl_vars['product']->value->available_for_order||(isset($_smarty_tpl->tpl_vars['restricted_country_mode']->value)&&$_smarty_tpl->tpl_vars['restricted_country_mode']->value)||$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value){?>
				<span class="exclusive">
					<span></span>
					<?php echo smartyTranslate(array('s'=>'Add to cart','mod'=>'csquickview'),$_smarty_tpl);?>

				</span>
			<?php }else{ ?>
				<p id="add_to_cart" class="buttons_bottom_block">
					<span></span>
					<input type="submit" name="Submit" onclick="return closeFancy()" value="<?php echo smartyTranslate(array('s'=>'Add to cart','mod'=>'csquickview'),$_smarty_tpl);?>
" class="exclusive" />
				</p>
			<?php }?>
...
<ul class="idTabs clearfix">
	<li><a href="#discount" style="cursor: pointer" class="selected"><?php echo smartyTranslate(array('s'=>'Quantity discount','mod'=>'csquickview'),$_smarty_tpl);?>
</a></li>
</ul>
<div id="quantityDiscount">
	<table class="std">
        <thead>
            <tr>
                <th><?php echo smartyTranslate(array('s'=>'product','mod'=>'csquickview'),$_smarty_tpl);?>
</th>
                <th><?php echo smartyTranslate(array('s'=>'from (qty)','mod'=>'csquickview'),$_smarty_tpl);?>
</th>
                <th><?php echo smartyTranslate(array('s'=>'discount','mod'=>'csquickview'),$_smarty_tpl);?>
</th>
            </tr>
        </thead>
		<tbody>
