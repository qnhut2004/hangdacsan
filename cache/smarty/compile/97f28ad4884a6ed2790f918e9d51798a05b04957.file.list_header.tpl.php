<?php /* Smarty version Smarty-3.1.13, created on 2015-03-26 02:51:51
         compiled from "/home/han4a2d1/public_html/han4a2d1admin/themes/default/template/controllers/categories/helpers/list/list_header.tpl" */ ?>
<?php /*%%SmartyHeaderCode:12272552185513ac87338679-85258452%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '97f28ad4884a6ed2790f918e9d51798a05b04957' => 
    array (
      0 => '/home/han4a2d1/public_html/han4a2d1admin/themes/default/template/controllers/categories/helpers/list/list_header.tpl',
      1 => 1397156384,
      2 => 'file',
    ),
    '207a7a557c49bdd9bcff421f6659a5f1e964f001' => 
    array (
      0 => '/home/han4a2d1/public_html/han4a2d1admin/themes/default/template/helpers/list/list_header.tpl',
      1 => 1397155724,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '12272552185513ac87338679-85258452',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5513ac876b3c56_11693639',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5513ac876b3c56_11693639')) {function content_5513ac876b3c56_11693639($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/home/han4a2d1/public_html/tools/smarty/plugins/modifier.escape.php';
?>
...
" />
	...
	<?php if (isset($_smarty_tpl->tpl_vars['show_assign_product_button']->value)&&$_smarty_tpl->tpl_vars['show_assign_product_button']->value==1){?>
	<div>
		<script language="javascript" type="text/javascript">
			function confirm_assignall_submit()
			{
				ans = confirm("<?php echo smartyTranslate(array('s'=>'are you sure proceed to assign all products under this category including subcategories to the owner of current category?'),$_smarty_tpl);?>
");
				if(ans)$("#assignall").submit();
			}
		</script>
		<form id="assignall" method="post" action="">
			<input type="hidden" name="assign_all_products" id="assign_all_products" value="1">
			 <?php echo smartyTranslate(array('s'=>'To assign all products under this category including subcategories to the owner of current category, please ckick next button '),$_smarty_tpl);?>

			<input type="button" id="btnAssignAllProduct" value="<?php echo smartyTranslate(array('s'=>'Assign All Products'),$_smarty_tpl);?>
" class="button" onclick="javascript:confirm_assignall_submit();">
		</form>
	</div>
	<?php }?>
</div>
